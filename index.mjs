// Banco Central de la República Dominicana exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bcrd';
...
/** Latest rate for one pair, e.g. getRate('USD', 'DOP', { apiKey }). */
